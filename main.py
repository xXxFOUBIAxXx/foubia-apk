...
addr.to_bytes(4, 'big'),
    ...
    def gen_squad5(self):
        ...
        #----
    def invisible1(self):
        ent_packet = f" 050000030d08{self.EncryptedPlayerid}1005203a2a800608{self.EncryptedPlayerid}12024d4518012005328c0508{self.EncryptedPlayerid}"
        self.sock0500.send(bytes.fromhex(ent_packet))
...
def garin(self):
        ...
        self.sock0500.send(bytes.fromhex(ent_packet))                   
       # self.op.send(b'\x05\x03\x00\x00')
...
self.sock1200.send(bytes.fromhex(ent_packet))
       #--------
def help1(self):
        ent_packet = f" 120000013108{self.EncryptedPlayerid}101220022aa40208{self.EncryptedPlayerid}10{self.EncryptedPlayerid}"
        self.sock1200.send(bytes.fromhex(ent_packet))
...
def help2(self):
        ...
        self.sock1200.send(bytes.fromhex(ent_packet))                   
def help3(self):
        ent_packet = f" 120000012108{self.EncryptedPlayerid}101220022a940208{self.EncryptedPlayerid}10{self.EncryptedPlayerid}"
        self.sock1200.send(bytes.fromhex(ent_packet))
def help4(self):
        ent_packet = f" 120000012b08{self.EncryptedPlayerid}101220022a9e0208{self.EncryptedPlayerid}10{self.EncryptedPlayerid}"
        self.sock1200.send(bytes.fromhex(ent_packet))

def help5(self):
        ent_packet = f" 120000012908{self.EncryptedPlayerid}101220022a9c0208{self.EncryptedPlayerid}10{self.EncryptedPlayerid}"
        self.sock1200.send(bytes.fromhex(ent_packet))



def help6(self):
        ent_packet = f" 120000012e08{self.EncryptedPlayerid}101220022aa10208{self.EncryptedPlayerid}10{self.EncryptedPlayerid}"
        self.sock1200.send(bytes.fromhex(ent_packet))
